...
class MachineInfoPacket_v2:
    ...
    def Print(self):
        ...
        print "\tUnknown uint32_t 13: %s (0x%x)" %(self.unk13,self.unk13)
        print "\tUnknown uint32_t 14: %s (0x%x)" %(self.unk14,self.unk14)
        print "\tUnknown uint32_t 15: %s (0x%x)" %(self.unk15,self.unk15)
        print "\tUnknown uint32_t 16: %s (0x%x)" %(self.unk16,self.unk16)
        print "\tUnknown uint32_t 17: %s (0x%x)" %(self.unk17,self.unk17)
        print "\tUnknown uint32_t 18: %s (0x%x)" %(self.unk18,self.unk18)
        print "\tUnknown uint32_t 19: %s (0x%x)" %(self.unk19,self.unk19)
        print "\tUnknown uint32_t 20: %s (0x%x)" %(self.unk20,self.unk20)
        print "\tUnknown uint32_t 21: %s (0x%x)" %(self.unk21,self.unk21)
        print "\tUnknown uint32_t 22: %s (0x%x)" %(self.unk22,self.unk22)
