...
func UnmarshalBodyOrDie(outData interface{}, w http.ResponseWriter, r *http.Request, logI *slog.Instance) bool {
	...
	if err != nil {
		logI.Error(err)
		WriteJSON(models.NewErrorObject(models.InternalServerError, "body", err.Error(), nil), 500, w, r, logI)
		return false
	}
	...
	if err != nil {
		logI.Error(err)
		WriteJSON(models.NewErrorObject(models.InvalidFieldData, "body", err.Error(), nil), 500, w, r, logI)
		return false
	}
...
func InvalidFieldData(field string, message string, w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.InvalidFieldData, field, message, nil), 400, w, r, logI)
}

func PermissionDenied(field string, message string, w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.PermissionDenied, field, message, nil), 400, w, r, logI)
}

func NotFound(field string, message string, w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.NotFound, field, message, nil), 400, w, r, logI)
}

func NotImplemented(w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.NotImplemented, "server", "This call is not implemented", nil), 400, w, r, logI)
}

func CatchAllError(data interface{}, w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.InternalServerError, "server", "There was an internal server error.", data), 500, w, r, logI)
}

func CatchAllRouter(w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.NotFound, "path", "The specified URL does not exists.", nil), 404, w, r, logI)
}

func InternalServerError(message string, data interface{}, w http.ResponseWriter, r *http.Request, logI *slog.Instance) {
	WriteJSON(models.NewErrorObject(models.InternalServerError, "server", message, data), 500, w, r, logI)
}
